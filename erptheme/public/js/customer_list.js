    ...
    <div class="custom-list-container">
      <div class="custom-box">
        <div class="box-left">
          ...
          <div class="box-title">Total Customers</div>
        </div>
        <div class="box-right">
          <img src="/assets/erptheme/images/customers.png" alt="icon" style="width: 42px; height: 42px;">
        </div>
      </div>
      <div class="custom-box">
        <div class="box-left">
          <div class="box-value" id="draft_box">0</div>
          <div class="box-title">Is Frozen</div>
        </div>
        <div class="box-right">
          <img src="/assets/erptheme/images/frozen.png" alt="icon" style="width: 42px; height: 42px;">
        </div>
      </div>
      <div class="custom-box">
        <div class="box-left">
          <div class="box-value" id="disabled_box">0</div>
          <div class="box-title">Disabled</div>
        </div>
        <div class="box-right">
          <img src="/assets/erptheme/images/disabled.png" alt="icon" style="width: 42px; height: 42px;">
        </div>
      </div>
    </div>
  </div>
...
//   frappe.db.count("Sales Person", { filters: { advance_paid: [">", 0] } })
//     .then(c => {
//       const e = document.getElementById("unpaid_box");
//       if (e) e.textContent = c;
//     });

  frappe.db.count("Customer", { filters: { is_frozen: 1 } })
    .then(c => {
      const e = document.getElementById("draft_box");
      if (e) e.textContent = c;
    });

    frappe.db.count("Customer", { filters: { disabled: 1 } })
    .then(c => {
      const e = document.getElementById("disabled_box");
      if (e) e.textContent = c;
    });
}
...
extend_listview_event("Customer", "onload", function (listview) {
  insert_custom_block(listview);
