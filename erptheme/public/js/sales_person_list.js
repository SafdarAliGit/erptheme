    ...
    <div class="custom-list-container">
      <div class="custom-box">
        <div class="box-left">
          ...
          <div class="box-title">Total Sales Persons</div>
        </div>
        <div class="box-right">
          <img src="/assets/erptheme/images/sales_persons.png" alt="icon" style="width: 42px; height: 42px;">
        </div>
      </div>
      <div class="custom-box">
        <div class="box-left">
          <div class="box-value" id="draft_box">0</div>
          <div class="box-title">Enabled</div>
        </div>
        <div class="box-right">
          <img src="/assets/erptheme/images/enabled.png" alt="icon" style="width: 42px; height: 42px;">
        </div>
      </div>
    </div>
  </div>
...
// ================= Update stats ====================
function update_sales_person_stats() {
  frappe.call({
...
//     });
  ...
  frappe.db.count("Sales Person", { filters: { enabled: 1 } })
    .then(c => {
...
extend_listview_event("Sales Person", "onload", function (listview) {
  insert_custom_block(listview);
